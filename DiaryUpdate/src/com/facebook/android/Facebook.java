    ...
    public void authorize(Context context,
        ...
        dialog(context, LOGIN, params, new DialogListener() {
            ...
            public void onComplete(Bundle values) {
                ...
                if (isSessionValid()) {
                    Log.d("ZZ: Facebook-authorize", "Login Success! access_token="  + getAccessToken() + " expires=" + getAccessExpires());
            ...
            public void onError(DialogError error) {
                Log.d("ZZ: Facebook-authorize", "Login failed: " + error);
            ...
            public void onCancel() {
                Log.d("ZZ: Facebook-authorize", "Login cancelled");
                listener.onCancel();
            }
        });
    }
